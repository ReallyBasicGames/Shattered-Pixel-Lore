...
public class v2_X_Changes {
	...
	public static void add_v2_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.SHPX), "Overview",
			"Completly new heroes and their stories!\n\n" +
			"Expect to hear more about our favorite _prisoner_ in the future..."));

		changes = new ChangeInfo("v2.0.0", true, "");
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);

		changes = new ChangeInfo("v2.0.0", false, null);
		changes.hardlight(Window.TITLE_COLOR);
		changeInfos.add(changes);
